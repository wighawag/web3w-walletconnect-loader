...
declare type ProviderEvent = 'connect' | 'disconnect' | 'message' | 'chainChanged' | 'accountsChanged' | 'session_delete' | 'session_event' | 'session_update' | 'display_uri';
...
declare type SessionTypesNamespace = SessionTypesBaseNamespace;
declare type SessionTypesNamespaces = Record<string, SessionTypesNamespace>;
declare type ProposalTypesStruct = any;
...
declare type Web3ModalConfig = Omit<ConfigCtrlState, 'enableStandaloneMode'> & {
    walletConnectVersion: 1 | 2;
};
